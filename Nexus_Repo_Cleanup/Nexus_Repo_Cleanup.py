...
ARTIFACTGROUP = sys.argv[2]
ARTIFACTNAME = sys.argv[3] # can be an artifact ID or None. None first searches for artifacts in the group
#ARTIFACTNAME ="analyses"
ARTIFACTMAXLASTMODIFIED = datetime.datetime.strptime("2017-08-30 12:00:00","%Y-%m-%d %H:%M:%S")
ARTIFACTMINLASTMODIFIED = datetime.datetime.strptime("2016-01-01 12:00:00","%Y-%m-%d %H:%M:%S")
